...
ggplot(urban_pop)+
  ...
  annotate(geom="text", x=1955, y=6, label="world", colour="black", size=4, family="Cambria")+

  
  geom_line(aes(year, More.developed.regions/1000000), color='steelblue')+
  annotate(geom="text", x=1965, y=5, label="More developed regions", colour="steelblue", size=4, family="Cambria")+
    
  geom_line(aes(year, Less.developed.regions/1000000), color='brown')+
  annotate(geom="text", x=1965, y=5.5, label="Less developed regions", colour="brown", size=4, family="Cambria")+
                                                                
  labs(x="year", y="urban population [b]")+
  theme_bw()+
